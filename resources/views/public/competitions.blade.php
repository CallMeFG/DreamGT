...
<div class="min-h-screen bg-[#050505] font-['Barlow'] text-white selection:bg-ewc-gold selection:text-black">
    ...
    <div class="relative py-20 px-6 border-b border-white/10 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto text-center">
            ...
            <p class="text-gray-400 mt-6 max-w-2xl mx-auto text-lg">
                Ikuti turnamen resmi Game Central. Total hadiah ratusan juta rupiah menanti para juara baru.
            </p>
        </div>
    </div>
    ...
    <div class="py-10 border-t border-white/10 text-center">
        <p class="text-gray-600 text-xs font-mono uppercase">Game Central Tournament Platform</p>
    </div>
</div>
@endsection